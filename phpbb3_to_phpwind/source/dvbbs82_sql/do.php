...
elseif ($step == 11)
{
	...
	while ($vote = $SDB->fetch_array($query))
	{
		...
		foreach ($voteitem as $k => $i)
		{
			if ($votenum[$k] && $i)
			{
				$votearray[$i] = array($i,$votenum[$k]); //TODO投票选项，投票帖数
			}
		}
